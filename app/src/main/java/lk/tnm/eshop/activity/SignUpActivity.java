...
import lk.tnm.eshop.databinding.ActivitySignUpBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.signupBtnSignup.setOnClickListener(view -> {
            ...
            if (password.length() < 6) {
                binding.signupInputPassword.setError("Password must be 6 character");
                binding.signupInputPassword.requestFocus();
                return;
            }

            if (!password.equals(retypepassword)){
                binding.signupInputRetypePassword.setError("Password not match");
